...
def get_config(mode='train'):
  ...
  factors = distribs.Product([
      MODES_SHAPES[mode],
      distribs.Continuous('x', 0.1, 0.7),
      distribs.Continuous('y', 0.1, 0.7),
      distribs.Discrete('scale', [0.20]),
      distribs.Discrete('c0', [0.9, 0.55, 0.27], probs=[0.4,0.25,0.35]),
